...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { content: @playlist.content, name: @playlist.name, title: @playlist.title } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { content: @playlist.content, name: @playlist.name, title: @playlist.title } }
